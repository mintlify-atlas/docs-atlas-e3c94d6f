---
title: "robots.txt Parsing and Disallow Enforcement in Spinney"
sidebarTitle: "robots.txt"
description: "Spinney auto-fetches robots.txt before crawling. Disallow rules under User-agent: * are enforced, and the overide option bypasses all path restrictions."
---
